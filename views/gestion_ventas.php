                ...
                <div class="row">
                    <div class="col-lg-2 mb-4">
                        <form id="form_filtro_gestionoventas">
                            <input type="text" class="form-control solo-numeros-dni" id="gv_dni" name="dni" placeholder="Ingrese un DNI">
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title fs-5" id="obtener-gestion-ventasLabel">Detalles y Edición de Ventas en Proceso</h1>
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control solo-letras" id="nombres_ob_gventas" name="nombres">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="dni_ob_gventas" class="form-label fw-bold">Dni</label>
                                <input type="text" class="form-control solo-numeros-dni" id="dni_ob_gventas" name="dni">
                            </div>
                            <div class="mb-3">
                                <label for="celular_ob_gventas" class="form-label fw-bold">Celular</label>
                                <input type="text" class="form-control solo-numeros-cel" id="celular_ob_gventas" name="celular">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="tem_ob_gventas" class="form-label fw-bold">TEM</label>
                                 <div class="input-group">
                                    ...
                                    <input type="text" class="form-control solo-numeros-interes" id="tem_ob_gventas" name="tem">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control solo-numeros-deci" id="credito_ob_gventas" name="credito" aria-describedby="basic-addon2">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="credito_ob_gventas" class="form-label fw-bold">Crédito</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control solo-numeros-deci" id="linea_ob_gventas" name="linea" aria-describedby="basic-addon2">
                                </div>
                            </div>
                            <div class="mb-3">
